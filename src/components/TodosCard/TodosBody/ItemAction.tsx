  ...
  return (
    <Fragment>
      <div className="flex flex-row justify-between p-[1rem] ">
        ...
        <p className="text-sm font-normal text-dark-grayish-blue-light cursor-pointer hover:text-very-dark-grayish-blue-light dark:hover:text-light-grayish-blue-dark">
          Clear Complete
        </p>
      </div>
    </Fragment>
